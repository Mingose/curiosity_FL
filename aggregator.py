...
from utils_old.torch_utils import *
...
class Aggregator(ABC):
    ...
    def __init__(
        ...
        # print("self.model_dim:[]".format(self.model_dim))

        self.n_clients = len(clients)

        # print("length clients:[]".format(self.n_clients))
        self.n_test_clients = len(test_clients)

        # print("length n_test_clients:{}".format(self.n_test_clients))
        self.n_learners = len(self.global_learners_ensemble)

        # print("length n_learners:{}".format(self.n_learners))
    ...
    def write_logs(self):
        ...
        # print(" I coming aggregater write_logs")
        ...
        for global_logger, clients in [
            ...
            for client_id, client in enumerate(clients):
                ...
                # print(" coming write_logs clients")
            ...
            # print(" Coming here write_logs on center")
        ...
        # print("I already remove write_logs now")
