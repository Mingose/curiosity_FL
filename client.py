...
class Client(object):
    ...
    def write_logs(self):
        ...
        if self.tune_locally:
            ...
            # print("now there client write logs no tune_locally")
        ...
        # print("coming clients write_logs kkkkkk")
        # print("train_loss{}, train_acc{}, test_loss{}, test_acc{}".format(train_loss, train_acc, test_loss, test_acc))
