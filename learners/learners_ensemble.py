...
class LearnersEnsemble(object):
    ...
    def fit_epochs(self, iterator, n_epochs, weights=None):
        ...
        for learner_id, learner in enumerate(self.learners):
            old_params = learner.get_param_tensor()
            if weights is not None:
                # print(f'leaner_ID:{learner_id},weights{weights[learner_id]}')
    ...
    def evaluate_iterator(self, iterator):
        ...
        # print("Now coming Learners_ensemble evaluate_iterator")
        ...
        with torch.no_grad():
            for (x, y, _) in iterator:
                ...
                # print("In learners_ensemble evaluater_iterator cyclic number")
            ...
            # print("gl:{},gs:{}".format( global_loss / n_samples, global_metric / n_samples))
            # print("This time iterater size = {}".format(n))
