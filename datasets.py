...
class SubCIFAR10(Dataset):
    ...
    def __init__(self, path, cifar10_data=None, cifar10_targets=None, transform=None,
                imbalance_ratio=0.0,use_imbalance_ratio=False,imb_type='exp'):
        """
        :param path: path to .pkl file; expected to store list of indices
        ...
        if use_imbalance_ratio:
            print("imbalance_ratio10=",imbalance_ratio)
...
class SubCIFAR100(Dataset):
    ...
    def __init__(self, path, cifar100_data=None, cifar100_targets=None, transform=None,\
        ...
        # print("use_imbalance_ratio1000:{}".format(use_imbalance_ratio))
        if use_imbalance_ratio:
            print("imbalance_ratio100=",imbalance_ratio)
            img_num_list = self.get_img_num_per_cls(self.cls_num, imb_type, imbalance_ratio)
            self.gen_imbalanced_data(img_num_list)
            self.transform = Compose([
                RandomCrop(32, padding=4),
